...
def load_data_(dataset_name, dataset_type):
    if dataset_name == 'cora':
        adj, features, labels, train_mask, val_mask, test_mask = load_data(path="./data/cora_/", dataset="cora")
...
def load_data__(dataset_name, dataset_type):
    if dataset_type == 'dgl' and dataset_name == 'cora':
        dataset_ = CoraGraphDataset('./data/cora/')
    if dataset_type == 'dgl' and dataset_name == 'citeseer':
        dataset_ = CiteseerGraphDataset('./data/citeseer/')
    if dataset_type == 'dgl' and dataset_name == 'pubmed':
        dataset_ = PubmedGraphDataset('./data/pubmed/')

    if dataset_type == 'ogb' and dataset_name == 'arxiv':
        dataset_ = DglNodePropPredDataset(root='./OGB/dataset', name='ogbn-arxiv')
